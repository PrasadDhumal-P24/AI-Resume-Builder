      ...
      <div ref={targetRef} className="resume__paper">
        ...
        <div className="resume__two-col">
                  ...
                  {skills.programmingLangs.split(',').map((lang, i) => {
                    ...
                    return (
                      <div key={i} className="resume__lang-item">
                        <span className="resume__lang-emoji">{emoji}</span>
                        <span>{lang.trim()}</span>
                      </div>
                    )
                  })}
                        ...
                        hobby.includes('travel') ? '✈️' :
                          hobby.includes('music') ? '🎵' :
                            hobby.includes('cricket') ? '🏏' :
                              hobby.includes('football') ? '⚽' :
                                hobby.includes('read') ? '📚' :
                                  hobby.includes('cod') ? '💻' :
                                    hobby.includes('photo') ? '📷' :
                                      hobby.includes('draw') || hobby.includes('art') ? '🎨' :
                                        hobby.includes('game') ? '🎮' :
                                          hobby.includes('cook') ? '🍳' :
                                            hobby.includes('danc') ? '💃' :
                                              hobby.includes('sing') ? '🎤' : '⭐'
                    return (
                      <li key={i}>{emoji} {h.trim()}</li>
                    )
                  })}
                </ul>
              </div>
          ...
          <div className="resume__col-right">
            ...
            {skills.certificates && (
              <div className="resume__col-section">
                <div className="resume__sec-title">
